<section class="hero" id="hero">
  <div>
    ...
    <div class="brand-strip" style="margin:10px 0 18px;">
      ...
      <span class="brand-chip">Kova chống thấm</span>
      <span class="brand-chip">Maxilite</span>
    </div>
    <div class="hero-actions">
      <a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class="btn btn-accent btn-lg">Xem bảng giá & chiết khấu</a>
      <a href="<?php echo esc_url(home_url('/lien-he')); ?>" class="btn btn-outline btn-lg">Nhận tư vấn kỹ thuật</a>
      <a href="tel:0944857999" class="btn btn-primary btn-lg">Gọi báo giá nhanh</a>
    </div>
  </div>
  <div class="hero-card">
