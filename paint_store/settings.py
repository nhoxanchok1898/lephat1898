...
AUTO-GENERATED: This file was auto-generated to provide minimal development settings.
For production, use paint_store/settings_production.py and set proper environment variables.

Generated by 'copilot/fix-admin-and-features' branch to enable local testing.
See https://docs.djangoproject.com/en/stable/topics/settings/ for more information.
"""
