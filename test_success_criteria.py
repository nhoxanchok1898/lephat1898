...
print(f"  [OK] {model.__name__} is a proper Django model")
...
print("  [OK] Product.brand -> Brand (ForeignKey)")
...
print("  [OK] Product.category -> Category (ForeignKey)")
...
print("  [OK] OrderItem.order -> Order (ForeignKey)")
...
print("  [OK] OrderItem.product -> Product (ForeignKey)")
...
print("  [OK] ProductView.product -> Product (ForeignKey)")
...
print("  [OK] ProductView.user -> User (ForeignKey)")
...
print("  [OK] ProductViewAnalytics.product -> Product (OneToOneField)")
...
print("  [OK] StockLevel.product -> Product (OneToOneField)")
...
print("  [OK] UserProfile.user -> User (OneToOneField)")
...
try:
    ...
    print("  [OK] from store.models import Brand")
    
    from store.models import Category
    print("  [OK] from store.models import Category")
    
    from store.models import Product
    print("  [OK] from store.models import Product")
    
    from store.models import Order
    print("  [OK] from store.models import Order")
    
    from store.models import OrderItem
    print("  [OK] from store.models import OrderItem")
    
    from store.models import ProductView
    print("  [OK] from store.models import ProductView")
    
    from store.models import ProductViewAnalytics
    print("  [OK] from store.models import ProductViewAnalytics")
    
    from store.models import StockLevel
    print("  [OK] from store.models import StockLevel")
    
    from store.models import LoginAttempt
    print("  [OK] from store.models import LoginAttempt")
    
    from store.models import SuspiciousActivity
    print("  [OK] from store.models import SuspiciousActivity")
    
    from store.models import UserProfile
    print("  [OK] from store.models import UserProfile")
...
print("  [OK] Brand has required fields (name, logo)")

# Category fields
assert hasattr(Category, 'name'), "Category should have 'name' field"
print("  [OK] Category has required fields (name)")
...
print(f"  [OK] Product has all {len(product_fields)} required fields")
...
print(f"  [OK] Order has all {len(order_fields)} required fields")
...
print(f"  [OK] OrderItem has all {len(orderitem_fields)} required fields")
...
print(f"  [OK] ProductView has all {len(productview_fields)} required fields")
...
print(f"  [OK] ProductViewAnalytics has all {len(analytics_fields)} required fields")
...
print(f"  [OK] StockLevel has all {len(stock_fields)} required fields")
...
print(f"  [OK] LoginAttempt has all {len(login_fields)} required fields")
...
print(f"  [OK] SuspiciousActivity has all {len(suspicious_fields)} required fields")
...
print(f"  [OK] UserProfile has all {len(userprofile_fields)} required fields")
...
print("  [OK] LoginAttempt is a proper Django model (not just a Python class)")
...
print("  [OK] SuspiciousActivity is a proper Django model (not just a Python class)")
...
# ============================================================================
print("=" * 80)
print("[OK] ALL SUCCESS CRITERIA MET!")
print("=" * 80)
print()
print("Summary:")
print("  [OK] All models properly defined as Django models")
print("  [OK] All ForeignKey and OneToOneField relationships correct")
print("  [OK] All imports work: from store.models import Brand, Category, Product, Order, ...")
print("  [OK] All required fields present in each model")
print("  [OK] LoginAttempt and SuspiciousActivity are proper Django models")
print()
